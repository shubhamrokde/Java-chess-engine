...
public final class Table extends Observable {
    ...
    private Table() {
        this.gameFrame = new JFrame("ChessEngine");
        ...
        this.useBook = false;
        this.pieceIconPath = "resources/holywarriors/";
    ...
    private JMenu createPreferencesMenu() {
        ...
        holyWarriorsMenuItem.addActionListener(e -> {
            pieceIconPath = "resources/holywarriors/";
            Table.get().getBoardPanel().drawBoard(chessBoard);
        });
        ...
        abstractMenMenuItem.addActionListener(e -> {
            pieceIconPath = "resources/simple/";
            Table.get().getBoardPanel().drawBoard(chessBoard);
        });

        fancyMenMenuItem2.addActionListener(e -> {
            pieceIconPath = "resources/fancy2/";
            Table.get().getBoardPanel().drawBoard(chessBoard);
        });

        fancyMenMenuItem.addActionListener(e -> {
            pieceIconPath = "resources/fancy/";
            Table.get().getBoardPanel().drawBoard(chessBoard);
        });
